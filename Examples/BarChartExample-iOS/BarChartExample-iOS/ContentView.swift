                        ...
                        ZStack {
                            ...
                            if self.entries.isEmpty {
                                ...
                                BarChartView()                                    
                                    ...
                                    .modifying(\.config.xAxis.labelsColor, value: Color.gray)
                                    .modifying(\.config.xAxis.ticksColor, value: Color.gray)
                                    .modifying(\.config.xAxis.labelsCTFont, value: self.labelsFont)
                                    .modifying(\.config.xAxis.ticksDash, value: [2, 4])
                                    .modifying(\.config.yAxis.labelsColor, value: Color.gray)
                                    .modifying(\.config.yAxis.ticksColor, value: Color.gray)
